...
shared.LoaderTitle = "Đăng Ký Kênh NguyễnTấnĐạt HUB(Prenium)";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://124597459793133",
...
local v15 = v14:CreateWindow({
    Title = "NguyễnTấnĐạt HUB(Prenium) Hub",
    SubTitle = "Blox Fruit",
    TabWidth = 160,
    Theme = "Dark",
    Acrylic = false,
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=124597459793133";
v24.Parent = v23;
...
if Sea3 then
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v594 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "NguyễnTấnĐạt HUB(Prenium)",
